...
| Refacto Tool 5 | 📋 **Plan rédigé**, exécution à venir | Tableau matriciel Tool 5, validator `quantize` discriminé par type, intègre LOOP côté UI (cycle 4-way), pas de bump NVS | [spec Tool 5 refacto](specs/2026-05-17-tool5-bank-config-refactor-design.md) | [plan](plans/2026-05-17-tool5-bank-config-refactor-plan.md) |
